...
- [ ] Implement phase-level rollups and summaries
  ...
  - [ ] Display phase totals in the accordion header or a summary bar
  - [ ] Add optional visual indicators (progress bars or badges) for variance thresholds
  - [ ] Include project-wide totals that sum across phases
